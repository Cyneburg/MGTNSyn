...
from .layers import GeneEmbAttention,TorchStandardScaler
from torch_geometric.nn import LayerNorm
from .layers_SDDSynergy import GAT_Block
# MGTNSyn  model
class MGTNSyn(torch.nn.Module):
    def __init__(self, num_features_xd=79, n_output=2, num_features_xt=954, output_dim=128, k_hop=4, dropout=0.2):
        ...
        #graphsage #num_heads=4, k_hop=k_hop, num_layers=2,
        ...
        # self.batchnorm = nn.BatchNorm1d(output_dim * 6)
